...
class TVTopRated extends StatefulWidget {
  @override
  _TVPTopRatedState createState() => _TVPTopRatedState();
}

class _TVPTopRatedState extends State<TVTopRated> {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        StreamBuilder<TVResponse>(
          stream: tvTopRatedBloc.subject.stream,
