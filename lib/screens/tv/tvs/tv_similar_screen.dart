...
class TVSimilarScreen extends StatefulWidget {
  int id;

  TVSimilarScreen({Key key, @required this.id}) : super(key: key);

  @override
  _TVSimilarScreenState createState() => _TVSimilarScreenState(id);
}

class _TVSimilarScreenState extends State<TVSimilarScreen> {
  int id;

  _TVSimilarScreenState(this.id);

  @override
  void initState() {
    super.initState();
    tvSimilarBloc.getTVSimilar(id);
  }
  ...
  void dispose() {
    super.dispose();
    tvSimilarBloc.drainStream();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<TVResponse>(
      stream: tvSimilarBloc.subject.stream,
